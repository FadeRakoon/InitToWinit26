...
const heroBackgroundImage =
  'linear-gradient(rgba(15, 23, 42, 0.8), rgba(15, 23, 42, 0.95)), url("https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=80&w=2072")'

export default function LandingPage() {
  return (
    <div
      className="min-h-screen bg-[var(--landing-bg-color)] text-[var(--landing-text-primary)]"
      style={{ fontFamily: 'Inter, ui-sans-serif, system-ui, sans-serif' }}
    >
      <nav className="fixed top-0 left-0 z-[100] flex h-[70px] w-full items-center justify-between border-b border-white/5 bg-[rgba(15,23,42,0.4)] px-5 shadow-[0_4px_30px_rgba(0,0,0,0.1)] backdrop-blur-[24px] sm:px-10">
      ...
      <main className="relative flex min-h-screen w-full items-center justify-center overflow-hidden px-5 pt-[70px]">
        ...
        <div className="landing-fade-up relative z-10 max-w-[800px] px-5 text-center">
          ...
          <div className="flex justify-center">
            <Link
              to="/map"
              className="inline-flex items-center gap-2.5 rounded-full bg-[var(--landing-accent)] px-9 py-4 text-[1.1rem] font-semibold text-white no-underline shadow-[0_10px_25px_rgba(56,189,248,0.4)] transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] hover:-translate-y-[3px] hover:shadow-[0_15px_35px_rgba(56,189,248,0.6)]"
            >
